...
COUNTRY_ADJECTIVES = {
    ...
    "lu": "Luxembourg", "lv": "Latvian", "ly": "Libyan", "ma": "Moroccan", "mc": "Monegasque", "md": "Moldovan",
    ...
    "wf": "Wallis and Futuna", "ws": "Samoan", "ye": "Yemeni", "za": "South African", "zm": "Zambian", "zw": "Zimbabwean"
}
...
# Rename internal dict for the helper functions
MID_MAP = get_country_code_from_mmsi.__globals__.get('mid_map', {})
# For legacy support if needed, but we'll use the ones defined above
